...
#define NUMBER_OF_OUTPUT_PETITREGISTERS                 500	                    // Petit Modbus RTU Slave Output Register Sayisi        
...
#define PETITMODBUS_TRANSMIT_BUFFER_SIZE                500
#define PETITMODBUS_RXTX_BUFFER_SIZE                    PETITMODBUS_TRANSMIT_BUFFER_SIZE

#define PETITMODBUS_TIMEOUTTIMER                        750                     // Petit Modbus RTU Slave icin timeout suresi [milisaniye]
...
#define PETITMODBUSWRITE_SINGLE_REGISTER_ENABLED        ( 1 )                   // Kullanilacaksa 1, kullanilmayacaksa 0
